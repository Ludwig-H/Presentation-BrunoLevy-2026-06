        ...
        \begin{column}{0.48\textwidth}
            \begin{center}
                \begin{tikzpicture}[scale=0.75, >=latex, font=\scriptsize]
                    ...
                    \coordinate (X1) at (-0.4, 0.5);
                    \coordinate (X2) at (0.6, -0.3);
                    \coordinate (X3) at (-0.5, -0.4);
                    \fill[black!60] (X1) circle (2pt);
                    \fill[black!60] (X2) circle (2pt);
                    \fill[black!60] (X3) circle (2pt);
                    
                    % Neighbors of Y (low density)
                    \coordinate (Y1) at (3.5, 2.2);
                    \coordinate (Y2) at (5.0, 0.2);
                    \fill[black!60] (Y1) circle (2pt);
                    \fill[black!60] (Y2) circle (2pt);
                    
                    % Core distance circles (K=3)
                    % For X: radius 0.7
                    \draw[dashed, inria-bleu, thick] (X) circle (0.7);
                    \draw[->, inria-bleu, semithick] (X) -- (-0.5, 0.49) node[midway, left=-2pt] {$r_K(x)$};
                    
                    % For Y: radius 1.3
                    \draw[dashed, inria-rouge, thick] (Y) circle (1.3);
                    \draw[->, inria-rouge, semithick] (Y) -- (3.5, 2.2) node[midway, right=1pt] {$r_K(y)$};
                    ...
                    % Distance d(x,y)
                    \draw[<->, black!50, dashed, thick] (X) -- (Y) node[midway, below] {$d(x,y)$};
    ...
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.48\textwidth}
            \begin{center}
                \begin{tikzpicture}[scale=0.75, >=latex, font=\scriptsize]
                    % Seuil r
                    \draw[<->, black!50, thick] (-1.5, 2.5) -- (0, 2.5) node[midway, above] {$r$};
                    
                    % Core point A
                    \coordinate (A) at (0,0);
                    \draw[dashed, inria-bleu, thick] (A) circle (1.5);
                    \fill[inria-bleu] (A) circle (3.5pt) node[below left] {$A$};
                    
                    % Neighbors inside A's circle
                    \coordinate (N1) at (-0.6, 0.8);
                    \coordinate (N2) at (0.8, 0.5);
                    \coordinate (N3) at (-0.4, -0.7);
                    \coordinate (B) at (1.2, -0.3); % Border point B
                    \fill[black!70] (N1) circle (2.5pt);
                    \fill[black!70] (N2) circle (2.5pt);
                    \fill[black!70] (N3) circle (2.5pt);
                    
                    % Border point B
                    \draw[dashed, inria-2024-bleu-canard, thick] (B) circle (1.5);
                    \fill[inria-2024-bleu-canard] (B) circle (3.5pt) node[right=4pt] {$B$};
                    
                    % Neighbors inside B's circle
                    \coordinate (N4) at (2.2, -0.9);
                    \fill[black!70] (N4) circle (2.5pt);
                    
                    % Noise point C
                    \coordinate (C) at (4.0, 1.8);
                    \draw[dashed, gray!50, thick] (C) circle (1.5);
                    \fill[gray] (C) circle (3.5pt) node[above left] {$C$};
                    \coordinate (N5) at (4.6, 2.3);
                    \fill[black!70] (N5) circle (2.5pt);
                    
                    % Connection
                    \draw[->, very thick, inria-rouge] (A) -- (B);
                \end{tikzpicture}
            \end{center}
        \end{column}
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                \setlength{\itemsep}{6pt}
                \item \textbf{Point cœur} (\textcolor{inria-bleu}{$A$}) : possède $\ge K$ voisins dans son rayon $r$ ($r_K(x) \le r$).
                \item \textbf{Point frontière} (\textcolor{inria-2024-bleu-canard}{$B$}) : proche de $A$, mais possède $< K$ voisins.
                \item \textbf{Bruit} (\textcolor{gray}{$C$}) : ni cœur, ni frontière.
            \end{itemize}
            
            \vspace{0.3cm}
            \begin{block}{De DBSCAN à HDBSCAN}
                DBSCAN requiert un seuil global $r$ unique. 
                \textbf{HDBSCAN} fait varier ce seuil continûment pour construire une hiérarchie complète sans paramètre d'échelle.
            \end{block}
        \end{column}
    \end{columns}
\end{frame}
    ...
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.32\textwidth}
            ...
            \begin{itemize}
                ...
                \item Mesure la stabilité d'un cluster $C$ à la densité $\lambda$ :
            ...
            \begin{block}{Simplification}
                De bas en haut :
                \begin{itemize}
                    \item Si la stabilité cumulée des enfants est supérieure à celle du parent, on garde la scission.
