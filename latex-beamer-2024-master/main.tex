...
\begin{frame}{Du Robust Single-Linkage à (H)DBSCAN}
    ...
    \vspace{0.4cm}
    \textbf{DBSCAN} (Ester \emph{et al.}, 1996) :
    \begin{itemize}
        \setlength{\itemsep}{6pt}
    ...
    \begin{block}{De DBSCAN à HDBSCAN}
        ...
        \textbf{HDBSCAN} (Campello \emph{et al.}, 2013) fait varier ce seuil continûment afin de s'affranchir de ce paramètre et de construire une hiérarchie complète.
    \end{block}
\end{frame}
