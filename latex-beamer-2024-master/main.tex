            ...
            \begin{center}
                ...
                \begin{tikzpicture}[xscale=0.95, yscale=0.95]
                    ...
                    \only<3>{
                        ...
                        \draw[inria-rouge, line width=1.5pt, rounded corners=5pt] (2.4, 1.5) -- (2.4, 1.3) -- (2.9, 1.3) -- (2.9, 1.1);
                        \node[above] at (2.4, 1.5) {\small $C_3$};
                        
                        \draw[inria-rouge, line width=1.5pt, rounded corners=5pt] (3.4, 3.2) -- (3.4, 1.3) -- (2.9, 1.3) -- (2.9, 1.1);
                        \node[above] at (3.4, 3.2) {\small $C_1$};
                    ...
                    \only<4>{
                        ...
                        \draw[inria-rouge, line width=1.5pt, rounded corners=5pt] (2.4, 1.5) -- (2.4, 1.3) -- (2.9, 1.3) -- (2.9, 0.9) -- (2.05, 0.9) -- (2.05, 0.8) -- (3.42, 0.8) -- (3.42, 0.4);
                        \node[above] at (2.4, 1.5) {\small $C_3$};
                        \node[above=2pt] at (2.9, 1.3) {\small $C_4$};
                        
                        % Branch C1 -> Merge 1 -> Trunk C4 -> Merge 2 -> Trunk C6 -> Merge 3 -> Trunk C7
                        \draw[inria-rouge, line width=1.5pt, rounded corners=5pt] (3.4, 3.2) -- (3.4, 1.3) -- (2.9, 1.3) -- (2.9, 0.9) -- (2.05, 0.9) -- (2.05, 0.8) -- (3.42, 0.8) -- (3.42, 0.4);
                        \node[above] at (3.4, 3.2) {\small $C_1$};
                        
                        % Branch C2 -> Merge 2 -> Trunk C6 -> Merge 3 -> Trunk C7
                        \draw[inria-rouge, line width=1.5pt, rounded corners=5pt] (1.2, 2.0) -- (1.2, 0.9) -- (2.05, 0.9) -- (2.05, 0.8) -- (3.42, 0.8) -- (3.42, 0.4);
                        \node[above] at (1.2, 2.0) {\small $C_2$};
                        \node[above=2pt] at (2.05, 0.9) {\small $C_6$};
                        
                        % Branch C5 -> Merge 3 -> Trunk C7
                        \draw[inria-rouge, line width=1.5pt, rounded corners=5pt] (4.8, 1.3) -- (4.8, 0.8) -- (3.42, 0.8) -- (3.42, 0.4);
                        \node[above] at (4.8, 1.3) {\small $C_5$};
...
\begin{frame}{Clustering sur données euclidiennes $\mathcal{X} \subset \mathbb{R}^d$ : estimation}
    ...
    \begin{center}
        \begin{tikzpicture}[xscale=1.2, yscale=1.2]
            ...
            \node (expensive) at (5.8, -1.8) [align=center] {
                \normalsize Méthodes naïves coûteuses\\
                \small (discrétisation de $\mathbb{R}^d$)
            };
            
            % Draw light blue arrow pointing up-right
            \draw[->, >=stealth, line width=2.5pt, inria-bleu!60] (4.2, -1.3) -- (5.0, -0.4);
