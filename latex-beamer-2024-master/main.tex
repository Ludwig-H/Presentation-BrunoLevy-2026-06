...
\begin{frame}{Robust SL / (H)DBSCAN ($K=2$)}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.44\textwidth}
            \begin{center}
                \textcolor{inria-bleu}{\textbf{Arbre hiérarchique}}
                
                \vspace{0.4cm}
                \begin{tikzpicture}[scale=0.75, >=latex, font=\scriptsize]
                    % Dendrogram branches for A, B, C, D, E, F (all very thick, inria-bleu)
                    \draw[very thick, inria-bleu] (0.5, 0.3) -- (0.5, 2.0);
                    \draw[very thick, inria-bleu] (1.5, 0.3) -- (1.5, 2.0);
                    \draw[very thick, inria-bleu] (2.5, 0.3) -- (2.5, 2.0);
                    \draw[very thick, inria-bleu] (3.5, 0.3) -- (3.5, 2.0);
                    \draw[very thick, inria-bleu] (4.5, 0.3) -- (4.5, 2.0);
                    \draw[very thick, inria-bleu] (5.5, 0.3) -- (5.5, 2.0);
                    
                    % Horizontal bar at y=2.0 (resolution 2r)
                    \draw[very thick, inria-bleu] (0.5, 2.0) -- (5.5, 2.0);
                    \draw[very thick, inria-bleu] (3.0, 2.0) -- (3.0, 2.8);
                    ...
                    \draw[dashed, inria-bleu] (-0.1, 2.0) -- (0.5, 2.0);
                    \node[left, inria-bleu] at (-0.1, 2.0) {$r$};
                \end{tikzpicture}
            \end{center}
        \end{column}
    \end{columns}
    ...
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.60\textwidth}
            \begin{itemize}
                ...
                \item Passage aux \textbf{hypergraphes} (\textbf{complexe de \v Cech} $\check{C}(\mathcal{X}, r)$) :
                \begin{itemize}
                    \setlength{\itemsep}{6pt}
                    \item Les interactions d'ordre supérieur (arêtes, triangles...) apparaissent aux intersections de boules de rayon $r$.
                \end{itemize}
                \item \textbf{Généralisation de la connexité} :
                \begin{itemize}
                    \setlength{\itemsep}{6pt}
                    \item Les composantes connexes sont remplacées par les \textbf{$K$-polyèdres} (composantes de $\Gamma_K(\mathcal{X}, r)$).
                    \item Pour $K \ge 2$, les polyèdres peuvent se recouvrir.
                    \item \textbf{Consistance exacte} avec les amas de densité de $\widehat{f}_{K\text{-NN}}$ (thèse Louis Hauseux).
                \end{itemize}
            \end{itemize}
        \end{column}
...
\begin{frame}{Robust SL vs. Vraie hiérarchie $2$-NN : Comparaison}
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.48\textwidth}
            \begin{center}
                \textcolor{inria-bleu}{\textbf{Hiérarchie Robust SL ($K=2$)}}
                
                \vspace{0.4cm}
                \begin{tikzpicture}[scale=0.75, >=latex, font=\scriptsize]
                    % Dendrogram branches for A, B, C, D, E, F (very thick, inria-bleu)
                    \draw[very thick, inria-bleu] (0.5, 0.3) -- (0.5, 2.0);
                    \draw[very thick, inria-bleu] (1.5, 0.3) -- (1.5, 2.0);
                    \draw[very thick, inria-bleu] (2.5, 0.3) -- (2.5, 2.0);
                    \draw[very thick, inria-bleu] (3.5, 0.3) -- (3.5, 2.0);
