...
\begin{frame}{Clustering sur données euclidiennes $\mathcal{X} \subset \mathbb{R}^d$ : le cas $K=2$}
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.58\textwidth}
            \begin{center}
                \begin{tikzpicture}[xscale=0.55, yscale=0.55]
                    ...
                    \tikzset{dot/.style={circle, fill=inria-2024-bleu-canard, inner sep=1.4pt, outer sep=0pt}}
                    \tikzset{cech_edge/.style={line width=0.5pt, gray!80}}
                    \tikzset{poly_contour_outer/.style={line width=8pt, inria-rouge, line join=round, line cap=round, opacity=0.8}}
                    \tikzset{poly_contour_inner/.style={line width=6.4pt, white, line join=round, line cap=round}}
                    \tikzset{poly_contour_outer_isolated/.style={line width=5pt, inria-rouge, line cap=round, opacity=0.7}}
                    \tikzset{poly_contour_inner_isolated/.style={line width=3.8pt, white, line cap=round}}
                    ...
                    % 2. Scale bar (Overlay 2-4)
                    \only<2-4>{
                        \draw[line width=1.5pt, inria-rouge] (5.2, 5.9) -- (5.75, 5.9);
                        \node[above] at (5.475, 5.9) {\small $r$};
                    }
                    
                    % 3. Cech Triangles (Overlay 3-4)
                    \only<3-4>{
                    ...
                    % 5. Contours of K-polyhedra (Overlay 4)
                    \only<4>{
                        % Outer contours (thick red)
                        \draw[poly_contour_outer] (7.04,3.24)--(7.16,3.92)--(7.91,3.8)--cycle;
                        \draw[poly_contour_outer] (8.31,3.24)--(8.85,3.91)--(7.91,3.8)--cycle;
                        \draw[poly_contour_outer] (2.89,1.18)--(3.66,1.24)--(4.4,1.59)--(4.33,0.85)--(3.51,0.51)--cycle;
                        \draw[poly_contour_outer] (2.15,2.64)--(1.47,2.64)--(1.04,1.76)--(1.69,1.9)--cycle;
                        \draw[poly_contour_outer] (2.41,4.96)--(1.73,5.45)--(1.01,5.13)--(1.65,4.56)--cycle;
                        \draw[poly_contour_outer] (5.23,3.21)--(4.37,2.77)--(4.64,3.77)--cycle;
                        
                        \draw[poly_contour_outer_isolated] (5.16,0.57)--(4.33,0.85);
                        \draw[poly_contour_outer_isolated] (6.02,4.14)--(5.94,3.29);
                        \draw[poly_contour_outer_isolated] (7.04,3.24)--(6.51,2.31);
                        \draw[poly_contour_outer_isolated] (7.04,3.24)--(7.71,2.56);
                        \draw[poly_contour_outer_isolated] (8.31,3.24)--(7.71,2.56);
                        \draw[poly_contour_outer_isolated] (8.31,3.24)--(9.13,2.85);
                        \draw[poly_contour_outer_isolated] (3.02,4.45)--(2.56,3.8);
                        \draw[poly_contour_outer_isolated] (3.02,4.45)--(2.41,4.96);
                        \draw[poly_contour_outer_isolated] (3.02,4.45)--(3.27,5.47);
                        \draw[poly_contour_outer_isolated] (6.51,2.31)--(5.71,1.83);
                        \draw[poly_contour_outer_isolated] (6.51,2.31)--(6.55,1.27);
                        \draw[poly_contour_outer_isolated] (7.71,2.56)--(8.39,1.89);
                        \draw[poly_contour_outer_isolated] (3.58,2.45)--(4.37,2.77);
                        \draw[poly_contour_outer_isolated] (3.58,2.45)--(3.65,3.45);
                        \draw[poly_contour_outer_isolated] (3.58,2.45)--(2.86,2.72);
                        \draw[poly_contour_outer_isolated] (6.66,5.36)--(7.27,4.75);
                        \draw[poly_contour_outer_isolated] (8.24,1.21)--(8.39,1.89);
                        \draw[poly_contour_outer_isolated] (8.24,1.21)--(7.39,0.91);
                        \draw[poly_contour_outer_isolated] (2.15,2.64)--(2.86,2.72);
                        \draw[poly_contour_outer_isolated] (8.16,5.38)--(7.27,4.75);
                        \draw[poly_contour_outer_isolated] (8.16,5.38)--(8.85,4.99);
                        \draw[poly_contour_outer_isolated] (8.85,3.91)--(9.13,2.85);
                        \draw[poly_contour_outer_isolated] (8.85,3.91)--(8.85,4.99);
                        \draw[poly_contour_outer_isolated] (4.7,4.94)--(4.09,5.44);
                        \draw[poly_contour_outer_isolated] (5.71,1.83)--(6.55,1.27);
                        \draw[poly_contour_outer_isolated] (8.39,1.89)--(9.39,2.11);
                        \draw[poly_contour_outer_isolated] (7.16,3.92)--(7.27,4.75);
                        \draw[poly_contour_outer_isolated] (5.23,3.21)--(5.94,3.29);
                        \draw[poly_contour_outer_isolated] (1.16,0.84)--(1.04,1.76);
                        \draw[poly_contour_outer_isolated] (7.39,0.91)--(6.55,1.27);
                        \draw[poly_contour_outer_isolated] (2.41,4.96)--(3.27,5.47);
                        \draw[poly_contour_outer_isolated] (4.37,2.77)--(3.65,3.45);
                        \draw[poly_contour_outer_isolated] (3.65,3.45)--(2.86,2.72);
                        \draw[poly_contour_outer_isolated] (3.65,3.45)--(4.64,3.77);
                        \draw[poly_contour_outer_isolated] (3.27,5.47)--(4.09,5.44);
                        \draw[poly_contour_outer_isolated] (9.39,2.11)--(9.13,2.85);
                        
                        % Inner contours (white, to create hollow outline)
                        \draw[poly_contour_inner] (7.04,3.24)--(7.16,3.92)--(7.91,3.8)--cycle;
                        \draw[poly_contour_inner] (8.31,3.24)--(8.85,3.91)--(7.91,3.8)--cycle;
                        \draw[poly_contour_inner] (2.89,1.18)--(3.66,1.24)--(4.4,1.59)--(4.33,0.85)--(3.51,0.51)--cycle;
                        \draw[poly_contour_inner] (2.15,2.64)--(1.47,2.64)--(1.04,1.76)--(1.69,1.9)--cycle;
                        \draw[poly_contour_inner] (2.41,4.96)--(1.73,5.45)--(1.01,5.13)--(1.65,4.56)--cycle;
                        \draw[poly_contour_inner] (5.23,3.21)--(4.37,2.77)--(4.64,3.77)--cycle;
                        
                        \draw[poly_contour_inner_isolated] (5.16,0.57)--(4.33,0.85);
                        \draw[poly_contour_inner_isolated] (6.02,4.14)--(5.94,3.29);
                        \draw[poly_contour_inner_isolated] (7.04,3.24)--(6.51,2.31);
                        \draw[poly_contour_inner_isolated] (7.04,3.24)--(7.71,2.56);
                        \draw[poly_contour_inner_isolated] (8.31,3.24)--(7.71,2.56);
                        \draw[poly_contour_inner_isolated] (8.31,3.24)--(9.13,2.85);
                        \draw[poly_contour_inner_isolated] (3.02,4.45)--(2.56,3.8);
                        \draw[poly_contour_inner_isolated] (3.02,4.45)--(2.41,4.96);
                        \draw[poly_contour_inner_isolated] (3.02,4.45)--(3.27,5.47);
                        \draw[poly_contour_inner_isolated] (6.51,2.31)--(5.71,1.83);
                        \draw[poly_contour_inner_isolated] (6.51,2.31)--(6.55,1.27);
                        \draw[poly_contour_inner_isolated] (7.71,2.56)--(8.39,1.89);
                        \draw[poly_contour_inner_isolated] (3.58,2.45)--(4.37,2.77);
                        \draw[poly_contour_inner_isolated] (3.58,2.45)--(3.65,3.45);
                        \draw[poly_contour_inner_isolated] (3.58,2.45)--(2.86,2.72);
                        \draw[poly_contour_inner_isolated] (6.66,5.36)--(7.27,4.75);
                        \draw[poly_contour_inner_isolated] (8.24,1.21)--(8.39,1.89);
                        \draw[poly_contour_inner_isolated] (8.24,1.21)--(7.39,0.91);
                        \draw[poly_contour_inner_isolated] (2.15,2.64)--(2.86,2.72);
                        \draw[poly_contour_inner_isolated] (8.16,5.38)--(7.27,4.75);
                        \draw[poly_contour_inner_isolated] (8.16,5.38)--(8.85,4.99);
                        \draw[poly_contour_inner_isolated] (8.85,3.91)--(9.13,2.85);
                        \draw[poly_contour_inner_isolated] (8.85,3.91)--(8.85,4.99);
                        \draw[poly_contour_inner_isolated] (4.7,4.94)--(4.09,5.44);
                        \draw[poly_contour_inner_isolated] (5.71,1.83)--(6.55,1.27);
                        \draw[poly_contour_inner_isolated] (8.39,1.89)--(9.39,2.11);
                        \draw[poly_contour_inner_isolated] (7.16,3.92)--(7.27,4.75);
                        \draw[poly_contour_inner_isolated] (5.23,3.21)--(5.94,3.29);
                        \draw[poly_contour_inner_isolated] (1.16,0.84)--(1.04,1.76);
                        \draw[poly_contour_inner_isolated] (7.39,0.91)--(6.55,1.27);
                        \draw[poly_contour_inner_isolated] (2.41,4.96)--(3.27,5.47);
                        \draw[poly_contour_inner_isolated] (4.37,2.77)--(3.65,3.45);
                        \draw[poly_contour_inner_isolated] (3.65,3.45)--(2.86,2.72);
                        \draw[poly_contour_inner_isolated] (3.65,3.45)--(4.64,3.77);
                        \draw[poly_contour_inner_isolated] (3.27,5.47)--(4.09,5.44);
                        \draw[poly_contour_inner_isolated] (9.39,2.11)--(9.13,2.85);
                    }
                    
                    % 6. Redraw Points (All Overlays)
                    \foreach \x/\y in {5.16/0.57, 6.02/4.14, 7.04/3.24, 8.31/3.24, 3.02/4.45, 6.51/2.31, 2.89/1.18, 7.71/2.56, 4.33/0.85, 3.58/2.45, 6.66/5.36, 8.24/1.21, 2.15/2.64, 1.65/4.56, 2.56/3.8, 8.16/5.38, 1.69/1.9, 8.85/3.91, 4.7/4.94, 5.71/1.83, 8.39/1.89, 0.52/4.12, 7.16/3.92, 1.47/2.64, 5.23/3.21, 1.16/0.84, 9.42/0.8, 7.39/0.91, 2.41/4.96, 4.37/2.77, 7.91/3.8, 3.65/3.45, 4.4/1.59, 2.86/2.72, 6.55/1.27, 3.27/5.47, 9.39/2.11, 3.66/1.24, 1.01/5.13, 1.04/1.76, 1.73/5.45, 4.64/3.77, 7.27/4.75, 4.09/5.44, 5.94/3.29, 9.13/2.85, 8.85/4.99, 3.51/0.51} {
                        \node[dot] at (\x, \y) {};
                    }
                \end{tikzpicture}
        ...
        \begin{column}{0.40\textwidth}
            ...
            \only<2>{
                \begin{center}
                    {\Large\mathversion{bold} $\widehat{\lambda}(x) \ge \lambda_0$} \\[6pt]
                    {\Large\mathversion{bold} $\Leftrightarrow r_2(x) \le r$}
                    
                    \vspace{0.8cm}
                    
                    Lignes de niveau de haute densité \\
                    = \textbf{modèle booléen d'ordre 2}
                \end{center}
            }
            \only<3>{
                \begin{center}
                    ...
                    Complexe de \v Cech : $\check{C}(\mathcal{X}, r)$ \\
                    \textbf{Interactions d'ordre supérieur} \\
                    (arêtes et triangles)
                \end{center}
            }
            \only<4>{
                \begin{center}
                    {\Large\mathversion{bold} $r_2(x) \le r$}
                    
                    \vspace{1.0cm}
                    
                    Clusters de haute densité \\
                    = \textbf{$K$-polyèdres} ($K=2$)
                    
                    \vspace{0.6cm}
                    \small
                    Généralisation des composantes connexes. Les $K$-polyèdres peuvent se recouvrir.
                \end{center}
            }
        \end{column}
    \end{columns}
    ...
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.44\textwidth}
            \begin{center}
                ...
                \vspace{0.4cm}
                \begin{tikzpicture}[scale=0.75, >=latex, font=\scriptsize]
                    % Dendrogram branches for A, B, C, D, E, F (all very thick, inria-rouge)
                    \draw[very thick, inria-rouge] (0.5, 0.3) -- (0.5, 2.0);
                    \draw[very thick, inria-rouge] (1.5, 0.3) -- (1.5, 2.0);
                    \draw[very thick, inria-rouge] (2.5, 0.3) -- (2.5, 2.0);
                    \draw[very thick, inria-rouge] (3.5, 0.3) -- (3.5, 2.0);
                    \draw[very thick, inria-rouge] (4.5, 0.3) -- (4.5, 2.0);
                    \draw[very thick, inria-rouge] (5.5, 0.3) -- (5.5, 2.0);
                    
                    % Horizontal bar at y=2.0 (resolution 2r)
                    \draw[very thick, inria-rouge] (0.5, 2.0) -- (5.5, 2.0);
                    \draw[very thick, inria-rouge] (3.0, 2.0) -- (3.0, 2.8);
                    ...
                    \draw[dashed, inria-rouge] (-0.1, 2.0) -- (0.5, 2.0);
                    \node[left, inria-rouge] at (-0.1, 2.0) {$r$};
                \end{tikzpicture}
            \end{center}
        \end{column}
    \end{columns}
...
\begin{frame}{Robust SL vs. Vraie hiérarchie $2$-NN : Comparaison}
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.48\textwidth}
            \begin{center}
                \textcolor{inria-rouge}{\textbf{Hiérarchie Robust SL ($K=2$)}}
                
                \vspace{0.4cm}
                \begin{tikzpicture}[scale=0.75, >=latex, font=\scriptsize]
                    % Dendrogram branches for A, B, C, D, E, F (very thick, inria-rouge)
                    \draw[very thick, inria-rouge] (0.5, 0.3) -- (0.5, 2.0);
                    \draw[very thick, inria-rouge] (1.5, 0.3) -- (1.5, 2.0);
                    \draw[very thick, inria-rouge] (2.5, 0.3) -- (2.5, 2.0);
                    \draw[very thick, inria-rouge] (3.5, 0.3) -- (3.5, 2.0);
