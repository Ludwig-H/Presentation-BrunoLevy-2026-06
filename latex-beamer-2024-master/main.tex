...
\begin{frame}{La vraie hiérarchie $2$-NN : échelle $r$}
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.52\textwidth}
            \begin{center}
                \textbf{Nuage et $2$-intersections au niveau $r$}
    ...
    \vspace{0.3cm}
    \begin{center}
        \small \textbf{Étape 1 :} les 7 segments de longueur $2r$ fusionnent au seuil $r$ pour former les composantes de départ.
    \end{center}
\end{frame}
...
\begin{frame}{La vraie hiérarchie $2$-NN : échelle $r'$}
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.52\textwidth}
            \begin{center}
                \textbf{Triangles et $3$-intersections à $r' = \frac{2\sqrt{3}}{3}r$}
    ...
    \vspace{0.3cm}
    \begin{center}
        \small \textbf{Étape 2 :} les $3$-intersections (en rouge) fusionnent les triangles à $r' = \frac{2\sqrt{3}}{3}r$. Le pont central $CD$ reste isolé.
    \end{center}
\end{frame}
...
\begin{frame}{La vraie hiérarchie $2$-NN : échelle $r''$}
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.52\textwidth}
            \begin{center}
                \textbf{Connexité globale à $r'' = \frac{AD}{2}$}
    ...
    \vspace{0.3cm}
    \begin{center}
        \small \textbf{Étape 3 :} la connexité globale est atteinte à $r'' = \frac{AD}{2}$ grâce aux points de tangence (en rouge) qui relient les trois blocs.
    \end{center}
\end{frame}
...
\begin{frame}{Robust SL vs. Vraie hiérarchie $2$-NN : Comparaison}
    ...
    \vspace{0.3cm}
    \begin{center}
        \small \textbf{Bilan :} la vraie hiérarchie $2$-NN sépare correctement les deux structures de forte densité ($ABC$ et $DEF$) du pont de liaison $C\text{-}D$, contrairement à Robust SL.
    \end{center}
\end{frame}
