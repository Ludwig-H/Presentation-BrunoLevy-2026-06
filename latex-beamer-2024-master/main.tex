    ...
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.54\textwidth}
            ...
            \begin{itemize}
                ...
                \end{itemize}
                \item \textbf{Simplexes de Gabriel} :
                \begin{itemize}
                    \item Les simplexes provoquant les fusions (simplexes séparants) sont de \textbf{Gabriel}.
                \end{itemize}
                \item \textbf{Support de calcul} :
                \begin{itemize}
                    \item La recherche se restreint aux simplexes de la \textbf{mosaïque de Delaunay d'ordre $K$}.
                \end{itemize}
            \end{itemize}
        \end{column}
        ...
        \begin{column}{0.44\textwidth}
            \begin{center}
                ...
                \begin{tabular}{lcc}
                    ...
                    \textbf{Condition} & Gabriel & Gabriel \\
                    \textbf{Support} & Delaunay & Delaunay d'ordre $K$ \\
                    \bottomrule
                \end{tabular}
            \end{center}
        \end{column}
