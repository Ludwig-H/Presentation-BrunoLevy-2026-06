    ...
    \begin{center}
        \begin{tikzpicture}[every node/.style={inner sep=0}]
            ...
            \node (raw) [draw=gray!30, line width=1.5pt, inner sep=2pt, label={[label distance=8pt]below:{\small Données brutes $\mathcal{X}$}}] 
                {\includegraphics[width=0.17\textwidth]{../Img_presentation_BrunoLevy/Nuage2D.png}};
            ...
            \node (clustered) at (6.8, 0) [draw=inria-rouge, line width=1.5pt, inner sep=2pt, label={[label distance=8pt]below:{\small Amas de forte densité}}] 
                {\includegraphics[width=0.17\textwidth]{../Img_presentation_BrunoLevy/Nuage2D_HDBSCAN.png}};
...
\begin{frame}{Clustering sur données euclidiennes $\mathcal{X} \subset \mathbb{R}^d$}
    ...
    \begin{center}
        \begin{tikzpicture}[every node/.style={inner sep=0}]
            % Données brutes
            \node (raw) [draw=gray!30, line width=1.5pt, inner sep=2pt, label={[label distance=6pt]below:{\small Données brutes $\mathcal{X}$}}] 
                {\includegraphics[width=0.17\textwidth]{../Img_presentation_BrunoLevy/Nuage2D.png}};
                
            % Données classées
            \node (clustered) at (6.8, 0) [draw=inria-rouge, line width=1.5pt, inner sep=2pt, label={[label distance=6pt]below:{\small Amas de forte densité}}] 
                {\includegraphics[width=0.17\textwidth]{../Img_presentation_BrunoLevy/Nuage2D_HDBSCAN.png}};
            ...
            % Nom de l'algo en-dessous
            \node (algo) at (3.4, -0.85) [align=center] {\small \textbf{HDBSCAN}\footnotemark[1] \cite{HDBSCAN, HDBSCAN2017}};
        \end{tikzpicture}
    \end{center}
    \footnotetext[1]{Hierarchical Density-Based Spatial Clustering of Applications with Noise}
    ...
    \begin{columns}[onlytextwidth]
        \begin{column}{0.48\textwidth}
            \begin{center}
                \tikz \node [draw=gray!30, line width=1.2pt, inner sep=2pt] 
                    {\includegraphics[height=1.1cm]{../Img_presentation_BrunoLevy/CondenseTree_OliveOil_HGP.png}};\\[6pt]
        ...
        \begin{column}{0.48\textwidth}
            \begin{center}
                \tikz \node [draw=gray!30, line width=1.2pt, inner sep=2pt] 
                    {\includegraphics[height=1.1cm]{../Img_presentation_BrunoLevy/FilamentsGalaxie.png}};\\[6pt]
