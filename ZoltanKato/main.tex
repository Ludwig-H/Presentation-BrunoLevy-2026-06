...
\hypersetup{
   ...
   pdftitle    = {Des statistiques aux (hyper)graphes. De l'intérêt des interactions d'ordre supérieur pour une bonne structure hiérarchique},
   pdfsubject  = {Présentation à Zoltan Kato},
   pdfkeywords = {Louis Hauseux, clustering, Delaunay, percolation, optimal transport}
}

\title[Des statistiques aux (hyper)graphes]{\large Des statistiques aux (hyper)graphes.\\[6pt] \normalsize \normalfont De l'intérêt des interactions d'ordre supérieur pour une bonne structure hiérarchique}
\subtitle{\small Présentation à Zoltan \href{https://www.inf.u-szeged.hu/~kato/}{\textsc{Kato}} (Université de Szeged)}
\date[25 juin 2026]{Jeudi 25 juin 2026}
\author[L. Hauseux]{%
